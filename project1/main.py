...
stop_words = np.genfromtxt('stopwords.txt', dtype='str')
...
# -------------------------------------------------------------------------------
# Problem 5: This code loads a 2D dataset from toy_data.txt, and trains your models using  𝑇=10,𝜆=0.2 .
# -------------------------------------------------------------------------------
#
...
# -------------------------------------------------------------------------------
# Problem 7: the training and validation accuracies of each algorithm with T = 10 and  𝜆  = 0.01 (the  𝜆  value only applies to Pegasos)
# -------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------
# Problem 8: Finding the best 𝑇  value for each of the perceptron and average percepton algorithms, and both the best  𝑇  and  𝜆  for the Pegasos algorithm.
# -------------------------------------------------------------------------------
#
